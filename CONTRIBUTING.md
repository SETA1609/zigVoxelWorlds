...
**Forbidden dependencies:** GPL, LGPL, AGPL, SSPL, Commons Clause, "non-commercial only" licenses. PRs introducing these will be declined. See [`docs/external-libs.md`](docs/external-libs.md) § 6.
